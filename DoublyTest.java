...
class DoublyTest {
	...
	void test() {
        ...
        assertThrows(java.lang.RuntimeException.class,() -> p.add(-1,100),"Invalid Index !");
        assertThrows(java.lang.RuntimeException.class,() -> p.add(-2,200),"Invalid Index !");
        ...
        assertThrows(java.lang.RuntimeException.class,() -> p.get(-1),"Invalid Index !");
        assertThrows(java.lang.RuntimeException.class,() -> p.get(-2),"Invalid Index !");
        ...
        assertEquals(40,p.get(4));
        assertEquals(50,p.get(5));
        assertEquals(60,p.get(6));
        p.remove(4);
