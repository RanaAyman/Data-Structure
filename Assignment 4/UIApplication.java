	...
	public static void main(String[] args) {
        ...
        case 1:
            ...
            if (Character.toUpperCase(poly1) != 'A' && Character.toUpperCase(poly1) != 'B' && Character.toUpperCase(poly1) != 'C')
                ...
                while (m.find())
                   ...
                   ////////////////////////////////////////////////////
                   for(int i=1 ; i<list.size();i+=2) {             // to eliminate terms with same exponent
                     for(int j =i+2 ; j<list.size() ; j+=2) {
                       if(list.get(i)== list.get(j)) {
                          list.set(i-1,(int) list.get(i-1)+(int)list.get(j-1));
                          list.remove(j-1);
                          list.remove(j-1);
                         }
                      }
        ...
        case 3:
            ...
            for(int i =0 ; i<ps.R.size();i+=2) {
    			System.out.printf("("+ps.R.get(i)+","+ps.R.get(i+1)+")");
    			if(i+1!=ps.R.size()-1) {
    				System.out.printf(",");
    			}
    		}
